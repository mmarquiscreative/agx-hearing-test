<div class="stage-volume" ng-controller="volumeController as volume">
  <div class="volume-body">
     ...
     <audio id="volumeAudio" src="/wp-content/plugins/agx-hearing-test/sounds/noise.mp3" loop autoplay></audio>
         <div class="btns-yn">
     <button ng-hide="volume.tonePlaying" ng-click="volume.startNoise()" class="btn-submit"> Play Audio<span class="glyphicon glyphicon-circle-arrow-right"></span></button>
    	<button ng-show="volume.tonePlaying" ng-click="volume.stopNoise()" ui-sref="stage.toneTest" class="btn-submit">Next Step <span class="glyphicon glyphicon-circle-arrow-right"></span></button>
    </div>
</div>