<div class="stage-volume" ng-controller="volumeController as volume">
  <div class="volume-body">
     ...
     <audio id="volumeAudio" ng-src="/wp-content/plugins/agx-hearing-test/sounds/noise.mp3" loop src="/wp-content/plugins/agx-hearing-test/sounds/noise.mp3" autoplay></audio>
         <div class="btns-yn">
